...
{
    public string Make { get; set; } // Vehicle manufacturer (e.g. audi or toyota)
    public string Model { get; set; } // Vehicle model (e.g. a4 or corolla)
    public string FuelType { get; set; } // Type of fuel used. Possible values: gas, diesel, electricity
    public string Drive { get; set; } // Drive transmission. Possible values: fwd (front-wheel drive), rwd (rear-wheel drive), awd (all-wheel drive), 4wd (four-wheel drive)
    public int? Cylinders { get; set; } // Number of cylinders in engine. Possible values: 2, 3, 4, 5, 6, 8, 10, 12, 16
    public string Transmission { get; set; } // Type of transmission. Possible values: manual, automatic
